...
export const cookiePolicy: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        "fp_access — httpOnly session cookie holding the access token so we can authenticate API requests while you use the Site. Validity follows the token expiry (refreshed while you stay signed in); the cookie itself may be retained up to 24 hours.",
        "fp_refresh — httpOnly cookie holding a refresh token used to obtain a new access token. Typical lifetime: up to 24 hours.",
      ],
    },
    {
